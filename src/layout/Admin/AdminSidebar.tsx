      ...
      ${isMobileOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`}
        ...
        >
            ...
            >
                <Link to="/">
                    <span
                        className={`text-2xl font-bold ${isExpanded || isHovered || isMobileOpen
                ...
                <nav className="mb-6">
                    <div className="flex flex-col gap-4">
                        <div>
                            ...
                            >
                                {isExpanded || isHovered || isMobileOpen ? "Menu" : <FiMoreHorizontal className="size-6" />}
                            </h2>
